...
::: {#def-}
## Independence
Random variables $X$ and $𝑌$ are said to be independent if their joint distribution factorizes into the product of their marginal distributions. That is, for all $x$, $y$
$$
