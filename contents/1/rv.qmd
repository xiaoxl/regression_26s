...
## Miscs
::: {.theorem #thm-empirical-rule}
## Empirical Rule (Normal Data)

If a random variable $X$ is approximately normally distributed with mean $\mu$
...
::: {.remark #rem-empirical-approx}
## Precision of the 95\% Rule

The statement that “about $95\%$ of observations lie within $2\sigma$ of the mean”
is an **approximation**.
...
$$
then the exact probability statement is
$$
P\bigl(\mu - 1.96\sigma \le X \le \mu + 1.96\sigma\bigr) = 0.95.
$$
...
::: {.remark #rem-why-use-2sd}
## Why $\boldsymbol{2\sigma}$ Is Still Used

The cutoff $\pm 2\sigma$ is widely used because:

1. It is easy to remember and communicate.
2. The difference from $1.96\sigma$ is small:
   $$
   P(|Z|\le 2) \approx 0.9545.
   $$
3. It provides a useful mental model of variability.

In contrast, the value $1.96$ arises naturally in
formal statistical inference, such as confidence intervals
and hypothesis testing.
:::


::: {.remark #rem-rule-vs-exact}
## Rule-of-Thumb vs. Exact Normal Theory
