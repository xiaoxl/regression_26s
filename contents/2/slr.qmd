...
$$
It represents the proportion of the total sample variability in $𝑌$ that is explained by the linear relationship between $𝑌$ and $X$. Equivalently, we have the following statement.
