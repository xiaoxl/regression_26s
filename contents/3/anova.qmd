...
<!-- A Type II ANOVA table (often called marginal sums of squares) tests each main effect after adjusting for the other main effects, while respecting model hierarchy when interactions are present. -->
...
4. Each row corresponds to a nested-model comparison.
:::
