...
(a) Fit the model and find a 90\% confidence interval for the true slope of the line. Interpret the result. (Hint: You need to decide which R code to use. confint()? or predict()?)
...
(a) Fit the simple linear regression model, $E(y)=\beta_0+\beta_1x$, to the data. 
...
(f) Find a 95\% confidence interval for the true slope of the line. (Hint: You need to decide which R code to use. confint()? or predict()?)
...
![Fill in the blanks in the SLR table](Fill out the table (SLR).jpg)

(a) Please fill in the five blanks in the table.
